...
const Profile:FC<test> = ({love='ram'}):ReactElement => {
  ...
  return (
    ...
    >
        ...
        sx={{
           ...
           marginBottom:'16px'   
        }}><Typography variant="h4" color="text.primary">{`${love.substring(0,1)}`}</Typography></Avatar>
        <Typography variant="h6" color="text.primary">{`Welcome, ${love}`}</Typography>
